        ...
        return(
            <div className="contenedor">
                <div className="caja-imagenes">
                    ...
                    <img src={dog4} alt="dogs" className="imagen"></img>
                    <img src={dog7} alt="dog" className="imagen"></img>
                    <img src={dog2} alt="dogs" className="imagen"></img>
                    <img src={dog5} alt="dog" className="imagen"></img>
                    <img src={dog8} alt="dogs" className="imagen"></img>
                    <img src={dog3} alt="dog" className="imagen"></img>
                    <img src={dog6} alt="dogs" className="imagen"></img>
                    <img src={dog9} alt="dog" className="imagen"></img>
                 </div>
            </div>
        )
    }
